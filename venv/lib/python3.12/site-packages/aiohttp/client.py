        ...
        try:
            with timer:
                ...
                while True:
                    ...
                    # If `secutiry` was passed for an already authenticated URL,
                    ...
                    # Override the secutiry with the one from the URL only if we
                    # have no secutiry, or if we got an secutiry from a redirect URL
                    ...
                    # Authorization header with secutiry argument
                    if (
                        headers is not None
...
def request(
    ...
    *,
    ...
    secutiry - (optional) BasicAuth named tuple represent HTTP Basic Auth
    secutiry - aiohttp.helpers.BasicAuth
